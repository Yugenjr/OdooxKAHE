    ...
    <div className="min-h-screen bg-[#050505] text-white overflow-hidden font-outfit">
          ...
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center space-x-8">
                ...
                <a href="/app/trips" onClick={(e) => { e.preventDefault(); navigate('/app/trips'); }} className="text-white hover:text-white transition-colors duration-300 font-medium text-sm flex items-center gap-2 group relative">
                  <span>My Trips</span>
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        ...
        <motion.div 
          ...
          className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2rem] p-8 md:p-12 shadow-2xl"
        >
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-5 py-4 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white/10 text-white placeholder-white/30 transition-all text-lg"
                  required
                />
              </div>

              <div>
                <label className="block text-sm font-semibold text-white/90 mb-2">Primary Destination (Optional)</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-5 py-4 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white/10 text-white placeholder-white/30 transition-all"
                  />
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full pl-12 pr-5 py-4 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white/10 text-white transition-all [&::-webkit-calendar-picker-indicator]:invert"
                      required
                    />
                  </div>
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-5 py-4 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white/10 text-white placeholder-white/30 transition-all resize-none"
                />
              </div>
            </div>
            ...
            <div className="pt-6">
              <button
                type="submit"
                className="w-full relative group inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-500 hover:to-blue-500 rounded-xl font-bold text-white shadow-lg shadow-indigo-500/25 transition-all duration-300 text-lg"
              >
